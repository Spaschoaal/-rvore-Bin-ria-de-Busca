...
def criar_arquivo_registros_e_indice():
    ...
    registros = [
        Registro("12345678901", "João", "01/01/1990"),
        Registro("98765432109", "Maria", "15/03/1985"),
        Registro("11223344556", "Carlos", "30/05/1995"),
...
if __name__ == "__main__":
    ...
    chave_busca = "98765432109"  # Substitua pela chave desejada
    acesso_dados = AcessoDadosABB()
    acesso_dados.buscar_registro_por_chave(chave_busca)
